...
Thursday was a challenging day. Monash University organised a Big Data Challenge Day for high school seniors with strong mathematics records. My responsibility was to do a master class on data analytics, and introduce them to working with big data. I was somewhat nervous about this. We had approximately 60 high school seniors from across Melbourne, spread across three computer labs at Monash University on Clayton campus, working for their first time with the open source software [R](www.r-project.org) to explore the pedestrian sensor data that is available on [Open Data Melbourne](https://data.melbourne.vic.gov.au/Transport-Movement/Pedestrian-Counts/b2ak-trbp). 
